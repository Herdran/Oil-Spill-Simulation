...
class ImageChangeController(tk.Frame):
    ...
    def on_focus_out_oil_to_add(self, event):
        self.validate_oil_to_add()
    ...
    def on_focus_out_oil_to_show(self, event):
        self.validate_minimal_oil_to_show()
...
# window_width_adjusted = viewer.winfo_width()
# window_height_adjusted = viewer.winfo_height()
# window_width_adjusted = 1026
window_width_adjusted = 1280
window_height_adjusted = 615
# TODO currently values set manually
