...
class DataProcessorImpl:
    ...
    def _get_certain_measurement(self, data: LoadedData, coordinates: Coordinates, time_stamp: pd.Timestamp) -> CertainMeasurement:
    ...
    @staticmethod
    def _get_interpolated_data(time_points: np.array, latitude_points: np.array, longitude_points: np.array, points: np.array, values: np.array) -> np.array:
