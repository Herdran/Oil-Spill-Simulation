...
def set_simulation_coordinates_parameters(TOP_COORD, DOWN_COORD, LEFT_COORD, RIGHT_COORD):
    global POINT_LAT_SIZE, POINT_LON_SIZE, POINT_LAT_CENTERS, POINT_LON_CENTERS, SIMULATION_INITIAL_PARAMETERS, SIMULATION_TIME
    ...
    SIMULATION_TIME = (SIMULATION_INITIAL_PARAMETERS.time.max - SIMULATION_INITIAL_PARAMETERS.time.min).total_seconds()